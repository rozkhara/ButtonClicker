...
public class ScorePanel : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        Factory_name_set_panel.text = GameManager.Instance.factoryName;
        User_name_set_panel.text = GameManager.Instance.userName;
        Factory_name_score_panel.text= GameManager.Instance.factoryName;
        User_name_score_panel.text= GameManager.Instance.userName;
    }

    public void Edit_Factory_name_end_edit()
    {
        GameManager.Instance.factoryName = Factory_name_input.text;
    ...
    {
        GameManager.Instance.userName = User_name_input.text;
